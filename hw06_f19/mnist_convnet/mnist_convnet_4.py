...
def build_tflearn_convnet_4():
    ...
    conv_layer_3 = conv_2d(pool_layer_2,
                       ...
                       activation='relu',
                       name='conv_layer_3')
    # convolutional layer of 80 5x5 features
    pool_layer_3 = max_pool_2d(conv_layer_3, 2, name='pool_layer_3')
    # convolutional layer of 160 4x4 features
    conv_layer_4 = conv_2d(pool_layer_2,
                       nb_filter=160,
                       filter_size=2,
                       activation='relu',
                       name='conv_layer_4')
    # convolutional layer of 40 2x2 features
