...
NAME = 'CNN_BEE2_2s_4Layer.tfl'
SAVE_POINT= f'{FOLDER}' + f'{NAME}'
CHECK_POINT = SAVE_POINT + '.meta'

beeX, beeY = tflearn.data_utils.image_preloader('BEE2_2S/class_labels.txt', image_shape=(90,90), mode='file', categorical_labels=True, normalize=True)
...
model.fit(beeX, beeY, validation_set = 0.2, n_epoch=25, shuffle=True,show_metric=True,run_id='CNN_BEE2_2s_4Layer')
