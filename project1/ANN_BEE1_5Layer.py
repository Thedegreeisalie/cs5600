...
fc_layer_2 = fully_connected(dropout_1, 512,activation='relu',name='fc_layer_2')
dropout_2 = dropout(fc_layer_2, 0.5)
fc_layer_3 = fully_connected(dropout_2, 104,activation='relu',name='fc_layer_3')
...
model.fit(beeX, beeY, validation_set = 0.2, n_epoch=10,shuffle=True,show_metric=True,run_id='ANN_BEE1_5Layer')
